...
//    NSString *path=[[NSBundle mainBundle] pathForResource:@"index2" ofType:@"html" inDirectory:@"assets"];
    NSString *path=[[NSBundle mainBundle] pathForResource:@"index3" ofType:@"html" inDirectory:@"assets"];
